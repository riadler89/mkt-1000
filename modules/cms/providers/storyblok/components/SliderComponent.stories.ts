...
/**
 * Storyblok Slider component displays a horizontal carousel of content with navigation controls.
 ...
 * - Supports any Storyblok content components within slides
...
const meta = {
  ...
  argTypes: {
    ...
    showNavigationArrows: {
      ...
      name: 'contentElement.showNavigationArrows',
    },
    showPaginationIndicators: {
      control: 'boolean',
      description: 'Whether to show pagination indicators',
      name: 'contentElement.showPaginationIndicators',
    },
  },
  parameters: {
    docs: {
